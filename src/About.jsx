      ...
      <article className="about-box" role="main">
        ...
        <div className="statement-text">
          <p>
            ...
            These early pieces, created during my Digital Painting studies, mark the beginning of my artistic direction.</p>
           <p> <span className="glow-name">For full works, submit an inquiry.</span>
          </p>
